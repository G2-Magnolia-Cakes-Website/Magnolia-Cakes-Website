...
function OnlineStore({ api }) {
  ...
  const handleAddToCart = (product) => {
    ...
    const cakeVariant = cakeVariants.find(
      (cakeVariant) =>
        cakeVariant.id === parseInt(selectedCakeVariants[product.id])
    );
    ...
    if (product.product_type === "Cupcake") {
      ...
      const cartItem = {
        name:
          product.name + " - " + flavor_chose.name + " - " + cakeVariant.size,
        type: "cake",
      ...
      const existingCartItemIndex = existingCart.findIndex(
        (item) =>
          ...
          item.variantId === selectedCakeVariants[product.id]
      );
  ...
  return (
    <div className="online-store-page-wrapper">
            ...
            <>
              {products.map((product) => (
                <div key={product.id} className="cake-item">
                  <div className="non-button-section">
                    <img
                      src={product.image}
                      alt={product.name}
                      className="image"
                    ...
                    <p>
                      ...
                      >
                        ...
                        {flavors
                          .filter(
                            (flavor) =>
                              flavor.product_item === product.id &&
                              flavor.active
                          )
                          .map((flavor) => (
                          ...
                          >
                            ...
                            {cakeVariants
                              .filter((cakeVariant) => {
                                return (
                                  cakeVariant.cake ===
                                    parseInt(selectedFlavor[product.id]) && // Filter by selected flavor
                                  cakeVariant.active
                                );
                              })
                              .map((cakeVariant) => (
                    ...
                    {product.active ? (
                      <div className="quantity-section">
                        ...
                        <div className="quantity-control">
                          ...
                          <span className="quantity__input">
                            {" "}
                  ...
                  {product.active &&
                    ...
                    (product.product_type === "Cake" &&
                      selectedCakeVariants[product.id] &&
                      quantities[product.id] > 0 &&
                      selectedFlavor[product.id]) ? (
                      <div className="buttons-section">
                        <button
